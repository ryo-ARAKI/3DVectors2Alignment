...
module DefineVectors
    ...
    Uniform distribution on unit sphere defined as
    θ ∈ [0, π]
    ψ ∈ [0, 2π]
    is generated by using unifrom random variable u ∈ [0, 1]
    θ = arccos(1-2u)
    ψ = 2πu
    """
    function distribute_random_angles(param, vectors)
        θ = acos.(1.0 .- 2.0*rand(Uniform(0.0, 1.0), param.num_vectors))  # 0≤θ≤π
